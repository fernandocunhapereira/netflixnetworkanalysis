...
def networkx_para_pyvis(G):
  grafo_gerado=Network(height='500px', width='100%',heading='', notebook=True, cdn_resources='in_line', bgcolor="#222222", font_color="white", select_menu=True, filter_menu=True)
